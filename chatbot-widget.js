...
function sendInputToGAS3(message, isUserMessage) {
    const GAS_URL3 = 'https://script.google.com/macros/s/AKfycbxleOXZodfqoQMwgPXmOlZaPkVinS3vzeEYjOZSpjzNtHAFBOGCc8bGw_Tvh97Id91x/exec'; // Replace with your actual URL
...
function startConversation() {
    fetch('https://chatbot-for-kids-city-usa-aberdeen-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-kids-city-usa-aberdeen-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGAS(message, isUserMessage) {
    var GAS_URL = 'https://script.google.com/macros/s/AKfycby0Gx8hAHahx9Vkk1iRjFfyB_7ZGj6Sp5ijqDA_TqH4luIynEsZZU-svKU60I-70Kgl/exec';
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbzzGGiZBzxEN3EcFxzmlXJ2C5yLZxxHarZ7VzSH5q1QXtQ--a8TwQQkFtdG5L63nMEF4w/exec';
